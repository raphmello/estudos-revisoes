...
public class ParallelStreamResultOrder {
    ...
    public static Set<Integer> listOrder(Set<Integer> inputList) {
        return inputList.parallelStream()
                .map(integer -> integer * 2)
    ...
    public static void main(String[] args) {
        ...
        Set<Integer> inputList2 = Set.of(1, 2, 3, 4, 5, 6, 7, 8);
        log("inputList : " + inputList2);
        Set<Integer> result2 = listOrder(inputList2);
        log("result : " + result2);
    }
}
